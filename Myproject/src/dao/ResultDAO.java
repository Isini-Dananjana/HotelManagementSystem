...
public class ResultDAO implements IResultDAO {
    ...
    private static final String INSERT_RESULT_SQL = "INSERT INTO studentresult.resultsheet1" + "  (student_class,student_roll,mark1,mark2,mark3,mark4,mark5,mark6,mark7,mark8,mark9,mark10) VALUES " +
            " (?,?,?,?,?,?,?,?,?,?,?,?);";
 
    private static final String SELECT_USER_BY_ID = "select id,student_class,student_roll,mark1,mark2,mark3,mark4,mark5,mark6,mark7,mark8,mark9,mark10 from resultsheet1 where id = ?;";
    
    private static final String UPDATE_RESULT_SQL = "update resultsheet1 set student_class = ? ,student_roll = ?,mark1= ?,mark2= ?,mark3= ?,mark4= ?,mark5= ?,mark6= ?,mark7= ?,mark8= ?,mark9= ?,mark10= ? where id = ?;";
    
    
    private static final String SELECT_ALL_RESULTS = "select * from resultsheet1;";
    
    private static final String DELETE_RESULT_SQL = "delete from resultsheet1 where id = ?;";
    
   		
    
    private static final String SELECT_USER_BY_I  = "select id,student_class,student_roll,mark1,mark2,mark3,mark4,mark5,mark6,mark7,mark8,mark9,mark10 from resultsheet1 where student_roll = ?;";
    ...
    public List < Result > selectAllResults() {
        ...
        try (Connection connection = con.getConnection();
            ...
            while (rs.next()) {
				...
				// double total = Double.parseDouble(mark1)+Double.parseDouble(mark1)+Double.parseDouble(mark1);
    ...
    public Result selectResult1(int id) {
    	Result result = null;
        // Step 1: Establishing a Connection
        try (Connection connection = con.getConnection();
            // Step 2:Create a statement using connection object
    ...
    public boolean deleteResult1(int id) throws SQLException {
        boolean rowDeleted;
    ...
    public List < Result > selectTotal1(String student_roll) {
        ...
        try (Connection connection = con.getConnection();
            ...
            while (rs.next()) {
            	...
            	String mark1= rs.getString("mark1");
				 ...
				 String mark9= rs.getString("mark9");
				 String mark10= rs.getString("mark10");
				 double total = Double.parseDouble(mark1)+Double.parseDouble(mark2)+Double.parseDouble(mark3)+Double.parseDouble(mark2)+Double.parseDouble(mark3)+Double.parseDouble(mark4)+Double.parseDouble(mark5)+Double.parseDouble(mark6)+Double.parseDouble(mark7)+Double.parseDouble(mark8);
