  ...
  <div class="header-right">
	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="https://www.javaguides.net" class="navbar-brand"> Student Results(Grade 1 - 5)</a>
			</div>
			...
			<ul class="navbar-nav" >
	          ...
	          <li>
	              <a href="<%=request.getContextPath()%>/Addmarks1-5.jsp" class="nav-link">Add Student Marks</a>
	          </li>
	          <li>
              <a href="<%=request.getContextPath()%>/ViewResult1"class="nav-link">View Student Marks</a>
	          </li>
	          <li>
	...
	<div class="row">
		...
		<div class="container">
			...
			<div class="container text-left">
				...
				<a href="<%=request.getContextPath()%>/Addmarks1-5.jsp" class="btn btn-success">Add
					New Result</a>
			</div>
			<br>
			...
			<table class="table table-bordered" style="background-color: white" border-color = "solid black">
				...
				<td><a href="EditResult1?id=<c:out value='${r.id}' />">Edit</a>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="deleteResult1?id=<c:out value='${r.id}' />">Delete</a></td>
