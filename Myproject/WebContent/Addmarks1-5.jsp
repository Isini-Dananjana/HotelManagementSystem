	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<ul class="navbar-nav" >
	          ...
	          <li>
	              <a href="<%=request.getContextPath()%>/list1" class="nav-link">View Results</a>
	          </li>
	          <li>
		...
		<div class="card">
			<div class="card-body">
				<c:if test="${result != null}">
					<form action="updateResult1" method="post">
				</c:if>
				<c:if test="${result == null}">
					<form action="insertResult1" method="post">
				</c:if>
