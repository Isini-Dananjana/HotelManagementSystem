...
import Com.Sewwandi.Model.PempAtteModelPresent;

/**
 * Servlet implementation class PerEmpAttenServlet
 */
@WebServlet("/PerEmpAttenPresentServlet")
public class PerEmpAttenPresentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PerEmpAttenPresentServlet() {
        super();
	...
	response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		AttenBeanPresent employeebean = new AttenBeanPresent(); 
			
		employeebean.setAttendanceId(emp);
					 
			PempAtteModelPresent newemp = new PempAtteModelPresent();
		String s4 = newemp.DeleteEmp(employeebean);
		response.sendRedirect("http://localhost:8090/Sewwandi/PerEmpAttenPresent.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("create") != null)
		{
			...
			AttenBeanPresent emp = new AttenBeanPresent();
			...
			PempAtteModelPresent ademp = new PempAtteModelPresent();			
			String e1 = ademp.insertEmp(emp);
			System.out.println("hi");
			
			
			response.sendRedirect("http://localhost:8090/Sewwandi/addAttendancePresent.jsp");
