...
public class UpdateEventServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = EventDB.updatebooking(eventId, customername, hallno, eventdate, eventtime, eventtype, eventdes, noguests, photo, deco, makeup);
		
		if(isTrue == true) {
			
			List<EventBean> eventDetails = EventDB.getEventDetails(eventId);
