<%@page import="supplier.Addorders"%>
...
List<Supplier_payment_bean> list=addorders.getvalues();
...
<tbody>
					<tr>
                    	...
                    	<td><a href="orderaddinventory.jsp?orderid=<%=obj_Supplier_payment_bean.getOrderid()%>">Add Items</a></td>
