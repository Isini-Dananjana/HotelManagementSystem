...
<title>Inventory add details</title>
...
.bg{background:url('img/iaw.jpg') no-repeat;
  width:100%;
  height:100%;
}
...
<body>
  ...
  <div class="header-right">
    ...
    <a href="#">Logout</a>
		...
		<br>
        <div class="h1">Item adding status</div>
...
<div class="wrapper">
  ...
  <img src="img/i2.jpg" style="width: 100%; height:200px;">	
<br>
<br>
<br>
<br>
...
<h2 style="color: #000; text-align: center;">Item added successfully!</h2>
...
<br>
<br>
<Button class="btn btn-primary btn-block"><a href="inventorydetails.jsp" style="color: #fff;">Check Item List</a></Button>
<br>
