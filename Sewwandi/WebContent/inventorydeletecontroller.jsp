...
<div class="wrapper">
  ...
  <div class="panel-body">
  	<form onsubmit="return validate()" action="<%= request.getContextPath() %>/inventorydetails.jsp" method="post" class="delete" >
 
  <img src="img/i4.jpg" style="width: 100%; height:200px;">
...
<%
    ...
    delete.deletevalues(itemid);
	
%>
<br>
<br>

<h2 style="color: #000; text-align: center;">Item Deleted Succussfully</h2>
