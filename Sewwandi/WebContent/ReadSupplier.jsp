  ...
  <div class="header-right">
    ...
    <a href="#">Logout</a>
       ...
       <br>
		...
		<br>
        <div class="h1">Supplier Details</div>
  ...
  <div class="col-md-12">
   <br>
    ...
    <div class="form-group pull-left">
			...
			<button class="btn btn-primary" style="margin-left:50px;" ><a href="ReadSupplierpdf.jsp" style="color:#fff;">Create a PDF</a></button>
...
<tbody>
					<tr>
						<td><%=obj_Supplier_User_Bean.getSupplierid()%></td>
                    	...
                    	<td><%=obj_Supplier_User_Bean.getSupplierbirth()%></td>
                    	<td><%=obj_Supplier_User_Bean.getSuppliergender()%></td>
                    	<td><%=obj_Supplier_User_Bean.getSupplierNIC()%></td>
                    	<td><%=obj_Supplier_User_Bean.getSupplierphone()%></td>
                    	<td><%=obj_Supplier_User_Bean.getSupplieremail()%></td>
                    	<td><%=obj_Supplier_User_Bean.getSupplieraddress()%></td>
                    	<td><%=obj_Supplier_User_Bean.getItemname()%></td>
                    	<td><%=obj_Supplier_User_Bean.getSupplierregidate()%></td>
                    	
                    	<td>
                    	
                    	<div class="button10">

						<a href="editSupplier.jsp?supplierid=<%=obj_Supplier_User_Bean.getSupplierid()%>">Edit</a>
						</div>
						...
						<a href="controller/delete_supplier_controller.jsp?supplierid=<%=obj_Supplier_User_Bean.getSupplierid()%>">Delete</a>
