...
<div class="header">
  <div class="header-right">
    ...
    <a href="customerhome.jsp">Logout</a>
  </div>
</div>
...
<div class="wrapper">
	...
	<br><br><br>
<!-- Editable table -->
<form method="post" action="AddBookingServelet" action="<%= request.getContextPath() %>/#">

<div class="card">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4"><i class='fas fa-book-reader' style='font-size:24px'></i>&nbsp My bookings</h3>
  <div class="card-body">
    <div id="table" class="table-editable">
     ...
     <%
			try{
				...
				String sql ="select * from room_reservation where cName ='"+cName+"' ";    
          ...
          <tr>
            ...
            <td>
              <span class="table-remove"><a
                  class="btn btn-success" name="updateBook" href="editReservation.jsp?roomReservationId=<%= resultSet.getString("roomReservationId") %>" style="color: rgb(255, 255, 255);"><i class='fas fa-user-edit'></i>Edit </a></span>
                  
            </td>
            <td>
              <span class="table-remove"><a
                  class="btn btn-danger btn-rounded btn-sm my-0" name="DeleteBook" href="DeleteReservation.jsp?roomReservationId=<%= resultSet.getString("roomReservationId") %>"   style="color: rgb(255, 255, 255);">    <i class="material-icons">delete</i>Cancel</a></span>
            </td>
             </form>
          </tr>
