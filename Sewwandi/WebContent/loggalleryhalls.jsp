<%@page import="image.galleryhalls"%>
...
<title>Event Halls Gallery</title>
...
<div class="header">
  <div class="header-right">
    ...
    <a href="#">Logout</a>
        ...
        <div class="h1">Event Halls Gallery</div>


 <%
 
 galleryhalls Galleryhalls= new galleryhalls();
        
        
 List<imagebean> imagelist=Galleryhalls.gethalls(); 
    ...
    <div class="row">   
      <div class="col-4-lg ml-4">
        ...
        <div class="card" style="width:800px; height:500px">
          <img src="data:image/jpg;Base64,<%=Imagebean.getImage() %>"  height="500px" width="800px" alt="Card Two" class="card-img-top">
        </div>
