...
.bg{background:url('img/cus.jpg') no-repeat;
  width:100%;
  height:100%;
}
...
<div class="header">
  ...
  <form action="loginServlet" method="post" class="add">
  ...
  <img src="img/10.jpg" style="width: 100%; height:150px;">
        ...
        <input type="submit" class="btn btn-primary" name="login" value="Sign in" style="width: 30%; text-align: center; position: absolute;">
<br>
<br>
<br>
