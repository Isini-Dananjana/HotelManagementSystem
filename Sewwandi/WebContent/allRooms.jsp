						...
						<div class="img" >
							...
							<div class="rdetails" >									
								...
								<input type="text" class="form-control" id="roomId"  name="roomId" value="<% out.print(roomId); %>" hidden>
									...
									<a class="btn btn-primary" name="updateRoom" href="editRooms.jsp?roomId=<%=resultSet.getString("roomId") %>" ><i class='fas fa-user-edit'></i>   Edit</a>											 
									<a class="btn btn-primary"  name ="DeleteRoom" href="DeleteRooms.jsp?roomId=<%=resultSet.getString("roomId") %>" ><i class="fa fa-remove"></i>  Delete</a>
								</form>					
							</div>
