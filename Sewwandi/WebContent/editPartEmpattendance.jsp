...
<div class="header">
  <div class="header-right">
    ...
    <a href="#">Log out</a>
        ...
        <div class="h1">Edit Part-Time Employee Attendance Details </div>
...
<div class="wrapper">
	<div class="sidebar">
		...
		<ul>
		<li>
		<form method="post" action="supplierDServlet">
    		<input id="searchemp" name="sitem" type="text" class="form-control" placeholder="Enter Employee first name"><br>
    		<center><input id="searchempBtn" name="search" type="submit" class="btn btn-primary" value="Search Employee details"  style = "background-color:#612a3f; padding: 6px; width: 200px height:100px"/>  </center>
    	</form> 
    	</li>
   ...
   <div   id="container" >
		<table class="table table-condensed"  style="  background-color: #fff; padding: 30px; width: 560px;">
		  ...
		  <td><input class="logText" type="date" name="date"  id="date" onchange="validateNewEmp()" value="<%=dateT%>" ></td>
		    <td><input class="noOutLine" type="text" name = "eid" style="border:none;width :50px" value="<%=empID%>" readonly="true"></input></td>
		    <td><input class="noOutLine"  type="text" name = "fname" style="border:none;width :70px"value="<%=firstName%>" readonly="true"></input></td> 
		    <td><input class="noOutLine"  type="text" name = "lname" style="border:none;width :70px" value="<%=lastName%>" ></input></td> 
