...
<title>Edit Supplier Payments</title>
...
<div class="wrapper">
 ...
 <form onsubmit="return validate()" action="<%= request.getContextPath() %>/EditSupplier_payment_controller.jsp" method="post" class="edit" >
...
<%
       ...
       Edit_supplier_payment obj_Edit_supplier_payment = new Edit_supplier_payment();
  		...
  		Supplier_payment_bean obj_Supplier_payment_bean=obj_Edit_supplier_payment.get_values(orderid);
...
<input type="hidden" name="supplierid" value="<%=obj_Supplier_payment_bean.getSupplierid()%>"/>


    <div class="form-group">
  		<label for="supplierfirstname">Supplier First Name</label>
     	<input type="text" class="form-control" id="supplierfirstname" name="supplierfirstname"  value="<%=obj_Supplier_payment_bean.getSupplierfirstname()%>"/>
    </div>


	   <div class="form-group">
  		<label for="supplierlastname">Supplier Last Name</label>
     	<input type="text" class="form-control" id="supplierlastname" name="supplierlastname" value="<%=obj_Supplier_payment_bean.getSupplierlastname()%>" />
    </div>
	
	 <div class="form-group">
    	<label for="supplieremail">E-Mail Address</label>
    <input type="text" class="form-control" id="supplieremail" name="supplieremail" value="<%=obj_Supplier_payment_bean.getSupplieremail()%>" />
    </div>


    <div class="form-group">
      <label for="itemname">Item Name</label>
      <input type="text" class="form-control" id="itemname" name="itemname"  value="<%=obj_Supplier_payment_bean.getItemname()%>" />
    </div>

    <div class="form-group">
      <label for="itemamount">Quantity</label>
      <input type="number" class="form-control" pattern="numbers" id="itemamount" name="itemamount" min="1"  value="<%=obj_Supplier_payment_bean.getItemamount()%>"/>
    </div>
    
    <div class="form-group">
      <label for="itemprice">Price per Item</label>
      <input type="number" class="form-control" pattern="numbers" id="itemprice" name="itemprice" min="1" placeholder="Enter the Price for one item"  required value="<%=obj_Supplier_payment_bean.getItemprice()%>"/>
    </div>
    
    <div class="form-group">
      <label for="orderdiscount">Discounts</label>
      <input type="number" class="form-control" pattern="numbers" id="orderdiscount" name="orderdiscount" min="1" placeholder="Enter the Discount price" required value="<%=obj_Supplier_payment_bean.getOrderdiscount()%>"/>
    </div>
...
<div class="form-group">
    	...
    	<input type="number" class="form-control" pattern="numbers" id="supplierpayment" name="supplierpayment" min="1" placeholder="Enter the Suppliers Payment" required value="<%=obj_Supplier_payment_bean.getSupplierpayment()%>"/>
    </div>

    <div class="form-group">
      <label for="receiveddate">Order Received Date</label>
      <input type="date" class="form-control" id="receiveddate" name="receiveddate" placeholder="Order Received Date" required  value="<%=obj_Supplier_payment_bean.getReceiveddate()%>"/>
    </div>  
