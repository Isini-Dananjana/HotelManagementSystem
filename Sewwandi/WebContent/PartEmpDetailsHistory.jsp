...
<tr>
		 ...
		 <%
			try{
				...
				String data;
				if(query != null ){ 
					data = "select * from delte_part_employee where firstname like '%"+query+"%'   or address like '%"+query+"%' or section like '%"+query+"%' or  designation like '%"+query+"%' ";
					}
				else{
					data = "select * from delte_part_employee order by employeeId desc  ";
				}
		  ...
		  <form action="editEmployee.jsp" method="post">
		    ...
		    <td><%=resultSet.getString("dailySalary") %> <input name="bSal" type="hidden" value="<%=resultSet.getString("dailysalary") %>"> </td>
