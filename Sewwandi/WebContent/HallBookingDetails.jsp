...
<div class="wrapper">
  ...
  <div class="col-md-6 col-sm-12">
 	...
 	<c:set var="hallno" value="${eve.hallno}"/>
 	...
 	<c:set var="tot" value="${eve.tot}"/>
     	...
     	<tr>
   		<td>Event Id &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</td>
   		<td>${eve.eventId}</td>
   		</tr>
   		...
   		<tr>
   		<td>Hall No &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</td>
   		<td>${eve.hallno}</td>
   		</tr>
   		
   		<tr>
   		<td>Event date &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp</td>
   		<td>${eve.eventdate}</td>
   		</tr>
