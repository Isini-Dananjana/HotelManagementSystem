...
<div class="header">
  ...
  <form action="registerServlet" method="post" onsubmit="return checkDetails();" class="add">
 
  <img src="img/3.jpg" style="width: 100%; height:150px;">
    ...
    <label>First Name</label>
        ...
        <table style="width:400px">
        	<tr>
        		<th style="text-align:right"><input type="radio" name="gender" value="male" required></th>
        		<th style="text-align:center;width:100px"><label>Male</label></th>
        		<th style="text-align:right"><input type="radio" name="gender" value="female" required></th>
    	...
    	<div>
        <input type="hidden" class="logText" name="date" id="date" value="<fmt:formatDate  value="${date}" type="date" pattern="YYYY-MM-dd"/>">
    	</div>
   
        <input type="submit" class="btn btn-primary" name="newRegister" value="Create my Account" style="width: 30%; text-align: center; position: absolute;">
<br>
<br>
<br>
...
<script>
	...
	window.onload = function(){
	    ...
	    if("1"==x){
	        ...
	        swal({
	            title: "Error",
	            text: "This Nic is Already Exists",
	            icon: "warning",
	            dangerMode: true,
	        });
	        <% session.setAttribute("errors_success", null); %>
