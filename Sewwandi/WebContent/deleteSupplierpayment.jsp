...
<%@page import="supplier.Removeorder"%>
...
<div class="container-fluid bg">
 ...
 <form onsubmit="return validate()" action="<%= request.getContextPath() %>/Read_supplier_payment.jsp" method="post" class="add" >
   		<img src="img/i15.jpg" style="width: 100%; height:150px;">
...
<%
    ...
    Removeorder delete=new Removeorder();
    delete.deletevalues(orderid);
	
%>
<br>
<br>

<h2 style="color: #000; text-align: center;">Order Removed</h2>
...
<br>
<br>
<input type="submit" class="btn btn-primary btn-block" value="Go back" style="color: #fff;" />
<br>
