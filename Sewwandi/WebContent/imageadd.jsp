...
.bg{background:url('img/imaw.jpg');
width:auto;
height:auto;
...
<div class="header">
  <div class="header-right">
    ...
    <a href="#">Logout</a>
		...
		<br>
        <div class="h1">Add New Image</div>
...
<div class="container-fluid bg">
  <div class="row">
	...
	<div class="panel-body">
 	...
 	<form onsubmit="return validate()" action="<%= request.getContextPath() %>/imageadd" method="post" class="add" >
 
  		<img src="img/i8.jpg" style="width: 100%; height:150px;">

    <div class="form-group"><br>    	
    <label for="imagetype">Equipment Type</label>
    <select size = "0" class="form-control" id="imagetype" name="imagetype" placeholder="Select the image type">
    	<option value="0">--Select the image type--</option>
      	<option value="1">Hotel</option>
		<option value="2">Foods</option>
		<option value="3">Rooms</option>
		<option value="4">Event Halls</option>
    ...
    <div class="form-group">
     	...
     	<input type="text" class="form-control" id="imagename" name="imagename" placeholder="Enter the Image name" />
    </div>

    <div class="form-group">
    	<label for="image">Upload the Image</label>
    	<input type="file" class="form-control"  id="image" name="image" placeholder="Upload the Image"/>
    </div>

<input type="submit" class="btn btn-primary" value="Add Image" style="width: 30%; text-align: center; position: relative;" />
