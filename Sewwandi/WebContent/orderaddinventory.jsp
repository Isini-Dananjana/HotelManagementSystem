...
<div class="header">
  <div class="header-right">
    ...
    <br>
        <div class="h1">Add order Items to the list</div>
...
<div class="wrapper">
 ...
 <form onsubmit="return validate()" action="<%= request.getContextPath() %>/validateorder" method="post" class="edit" >
...
<%
  		...
  		orderinsertbean Orderinsertbean=Orderinventory.getorder(orderid);
...
<label for="itemtype">Item Type</label>
    <select size = "0" class="form-control" id="itemtype" name="itemtype">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="itemname" name="itemname"  value="<%=Orderinsertbean.getItemname()%>" />
    </div>

    <div class="form-group">
      <label for="itemamount">Quantity</label>
      <input type="number" class="form-control" pattern="numbers" id="itemamount" name="itemamount" min="1"  value="<%=Orderinsertbean.getItemamount()%>"/>
    </div>

<div class="form-group">
    	<label for="itemalertamount">Enter the Item limit to get the Running low alert!</label>
    	<input type="number" class="form-control" pattern="numbers" id="itemalertamount" name="itemalertamount" min="1" />
    </div>
  ...
  <div class="form-group">
      ...
      <input type="textarea" class="form-control" style="width:100%; height:100px;" id="itemdescription" name="itemdescription" />
    </div>
