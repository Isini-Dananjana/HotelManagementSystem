...
<div class="wrapper">
  ...
  <form action="changePasswordServlet" method="post" onsubmit="return checkDetails()" class="add">
  ...
  <img src="img/10.jpg" style="width: 100%; height:150px;">
    ...
    <div class="form-group">
        ...
        <input type="submit" class="btn btn-primary" name="newRegister" value="Register" style="width: 30%; text-align: center; position: absolute;">
<br>
<br>
<br>
