		...
		<table class="table table-condensed"  style="  background-color: #fff; padding: 30px; width: 560px;">
		 ...
		 <%
			try{
				...
				String sql ="select * from per_empattendan";
		  ...
		  <form action="PerEmpAttenServlet" method="post">
		    ...
		    <td><input class="noOutLine"  name = "designation" style="border:none;width :100px"value="<%=resultSet.getString("designation") %>"></td>
		    <td><input class="noOutLine" name = "section" style="border:none;width :60px"value="<%=resultSet.getString("section") %>"></td>
		    <td><input class="noOutLine" name = "section" style="border:none;width :60px"value="<%=resultSet.getString("basicSalary") %>"></td>
