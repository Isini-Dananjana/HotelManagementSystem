  ...
  color:#fff;
		...
		*{
		...
		<% 
			...
			String birtday = request.getParameter("dob");
...
<div class="header">
  <div class="header-right">
    ...
    <a href="#">Log out</a>
        ...
        <div class="h1">Edit Employee</div>
...
<div class="wrapper">
	<div class="sidebar">
		...
		<li><a href="#"><center><img src="image/sew.jpg" width="100px" height="100px"> </center></a>
			...
			<li><a href="#"><i class="fa fa-address-card"></i>Add Permanent Employee</a></li>
			<li><a href="#"><i class="fa fa-download"></i>Permanent Employee Details</a></li>
			<li><a href="#"><i class="fa fa-wrench"></i>Add Part Time Employee</a></li>
			<li><a href="#"><i class="fa fa-cut"></i>Part time employee details</a></li>
...
<div style="backdround: #ad617b" >
 ...
 <form method="POST" action="PerEmpServlet" onsubmit="return validateNewEmp()" style="  background-color: #fff; padding: 30px; width: 560px;" > <!---form begins--->
		             
		              <center><h3 id="title">EDIT EMPLOYEE DETAILS HERE</h3></center>
		             
		                <table id="addEmpTable"  > <!--table begins -->
							
			               		<input   type="hidden" value="<% out.println(employeeId);%>" name="eid">
			                    <tr>
			                       <td ><lable class = "Stext" >  <b>First Name</b></lable> &nbsp;  <label id="fnameErro"></label>  </td> 
			                    </tr>
			                    
			                    <tr>			                    	
			                       <td ><input class="logText"  type="text" value="<%=firstName%>" name="fname" id="fname" onchange="validateNewEmp()" placeholder="Enter First Name"><br> </td>
			                    </tr>
			                    ...
			                    <tr>
			                        <td><input class="logText" type="text" value="<% out.println(lastName);%>" name="lname" id="lname" onchange="validateNewEmp()" placeholder="Enter Last Name"> </td>
			                    </tr>
			                    ...
			                    <tr>
			                        <td><input class="logText" type="date" value="<%=birtday%>" name="dob" value="" id="dob" onchange="validateNewEmp()" placeholder="DD/MM/YYYY"> </td>
			                    </tr>
			                    ...
			                    <tr>
			                        ...
			                        <td><input <% if("Male".equals(gender)){out.println("checked='checked'" );}%>   type="radio" name="gender"  value="Male" id="male" onchange="validateNewEmp()" >
			                        
			                        <lable style="color:black;"> Male </lable>
			                        
			                        <input <% if("Female".equals(gender)){out.println("checked='checked'" );}%>  class="" type="radio" name="gender"  value="Female" id="female" onchange="newEmployeeValidate" >
			                    ...
			                    <tr>
		                        	<td><input class="logText" type="text" value="<% out.println(phoneNumber);%>" name="pNo" id="pNo" max="10" onchange="validateNewEmp()" placeholder="Enter Phone Number"> </td>
		                    	</tr>
		                    ...
		                    <tr>
		                        <td><input class="logText" type="email" value="<% out.println(email);%>" name="email" id="email" onchange="validateNewEmp()" placeholder="Enter Email Address"> </td>
		                    </tr>
		                    ...
		                    <tr>
		                        <td><input class="logText" type="text" value="<% out.println(address);%>" name="address" id="address" onchange="validateNewEmp()" placeholder="Enter Address"> </td>
		                    </tr>
		                    ...
		                    <tr>
		                    	<td>
		                    		<select   class="logText" name="section" onchange="validateNewEmp()" placeholder="Select Section" >
				                         <option  ><% out.println(section);%> </option>
		                    ...
		                    <tr>
		                    	<td>
		                    		<select class="logText" name="designation" onchange="validateNewEmp()" placeholder="Select Designation" >
				                         <option><% out.println(designation);%></option>
		                     ...
		                     <tr>
		                       <td><lable class="Stext"><b>Basic Salary</b></lable> &nbsp;  <label id="bSalErro"></label> </td> 
		                    </tr>
		                    
		                    <tr>
		                        <td><input value="<% out.println(basicSalary);%>" class="logText" type="text"  name="bSal" id="bSal" onchange="validateNewEmp()" placeholder="Enter Basic Salary"> </td>
		                    </tr>
		                ...
		                <button name="edit" id = "submitbtn" type="submit"  class="btn btn-success" onclick="validateNewEmp()"> Edit Employee </button>
