...
<div class="container-fluid bg">
 ...
 <form onsubmit="return validate()" action="<%= request.getContextPath() %>/orderdetails.jsp" method="post" class="add" >
...
<h2 style="color: #000; text-align: center;">Order Deleted Successfully</h2>
