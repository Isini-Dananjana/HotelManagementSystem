...
<div class="header">
  <div class="header-right">
    ...
    <a href="#">Log out</a>
        ...
        <div class="h1">Part-Time Employee Details</div>
...
<div class="wrapper">
	<div class="sidebar">
		...
		<form method="post" action="">
    		<input name="fname" id="fname"  type="text" class="form-control" placeholder="Enter details to search.." ><br>
    		 	</form> 
    	</li>
		...
		<table class="table table-condensed"  style="  background-color: #fff; padding: 30px; width: 560px;">
		 ...
		 <%
			try{
				...
				String data;
				if(query != null ){ 
					data = "select * from part_employee where firstname like '%"+query+"%'   or address like '%"+query+"%' or section like '%"+query+"%' or  designation like '%"+query+"%' ";
					}
				else{
					data = "select * from part_employee order by employeeId desc  ";
				}
			...
			%>
		  <tr>
		  <form action="editPartEmployee.jsp" method="post">
		   ...
		   <td><%=resultSet.getString("phoneNumber") %> <input name="pNo" type="hidden" value="<%=resultSet.getString("phoneNumber") %>"></td>
		    ...
		    <td><%=resultSet.getString("dailySalary") %> <input name="dSal" type="hidden" value="<%=resultSet.getString("dailysalary") %>"> </td>
		    ...
		    <td><button class="btn btn-success" ><a href="PartEmpServlet?dEmpid=<%=resultSet.getString("employeeId") %>" >Delete</a></button></td>
		   
		    <input name="address" type="hidden" value="<%=resultSet.getString("address") %>">
		     <td><button style = " background-color: #f56c42" class="btn btn-success"  ><a  href="PartEmpServlet?dnewEmpid=<%=resultSet.getString("employeeId") %>" >Store</a></button></td>
