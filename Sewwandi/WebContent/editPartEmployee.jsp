...
<div style="backdround: #ad617b" >
 ...
 <form method="POST" action="PartEmpServlet" onsubmit="return validateNewEmp()" style="  background-color: #fff; padding: 30px; width: 560px;" > <!---form begins--->
		              ...
		              <center><h3 id="title">EDIT EMPLOYEE DETAILS HERE</h3></center>
		                ...
		                <table id="addEmpTable"  > <!--table begins -->
			                    ...
			                    <tr>			                    	
			                       <td ><input class="logText"  type="text" value="<% out.println(firstName);%>" name="fname" id="fname" onchange="validateNewEmp()" placeholder="Enter First Name"><br> </td>
			                    </tr>
			                    ...
			                    <tr>
			                        <td><input class="logText" type="date" value="<%=birtday%>" name="dob" value="" id="dob" onchange="validateNewEmp()"> </td>
			                    </tr>
		                    ...
		                    <tr>
		                        <td><input value="<% out.println(dailySalary);%>" class="logText" type="text"  name="dSal" id="dSal" onchange="validateNewEmp()" placeholder="Enter Basic Salary"> </td>
		                    </tr>
		                ...
		                <button name="edit" id = "submitbtn" type="submit"  class="btn btn-success" onclick="validateNewEmp()"> Add Employee </button>
