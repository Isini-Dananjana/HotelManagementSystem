...
<div class="wrapper">
    ...
    <br>
		<ul>
			...
			<li><a href="allmenu.jsp"><i class="material-icons" style= "font-size:27px">&#xe8ef;</i>&nbsp &nbsp All menu</a></li>
		...
		<div id = "addRoomBody" >
		 ...
		 <form   method="post" action="AddMenuServlet" onsubmit="return validateEventForm()"> 
			 ...
			 <label>Menu Name : </label> 
				 ...
				 <button type="submit" id="addbtn" name="updateMenu" ><span class="glyphicon glyphicon-plus"></span><i class='far fa-edit'></i>&nbsp Update menu</button> 
		 	</div>
