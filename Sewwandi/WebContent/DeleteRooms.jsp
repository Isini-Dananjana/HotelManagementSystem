...
<div id="cont" >
	...
	<%
        ...
        <option value="Non-AC Single Room">Non-AC Single Room</option>
				 ...
				 <button type="submit" id="addbtn" name="DeleteRoom" class="btn btn-danger" ><span class="glyphicon glyphicon-plus"></span><i class="fa fa-remove"></i>&nbsp Remove Room</button> 
		 	</div>
