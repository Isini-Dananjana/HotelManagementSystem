...
<%@ page import="inventory.Inventoriesremove"%>
...
<head>
	...
	<title>Items remove Details</title>
...
<body>
  ...
  <div class="header-right">
    ...
    <br>
        <div class="h1">Item Remove Details</div>
...
<br>
			...
			<butto class="btn btn-primary" style="margin-left:50px;" ><a href="inventoryremovepdf.jsp" style="color:#fff;">Create a PDF</a></button>
...
<br>
 ...
 Inventoriesremove inventoriesremove= new Inventoriesremove();
        ...
        List<inventoryremovebean> inventoryremovelist=inventoriesremove.getvalues(); 
      
        Iterator<inventoryremovebean> it_inventoryremovelist=inventoryremovelist.iterator();        
%> 
           ...
           <div class="scrollable">
			...
			<table class="table table-bordered table-striped results">
				<thead>
						<th><b>Item ID</b></th>
                    	<th><b>Item Name</b></th>
                    	<th><b>Quantity After Removed</b></th>
                    	<th><b>Removed Amount</b></th>
...
<%   
  while(it_inventoryremovelist.hasNext()){
  
  inventoryremovebean Inventoryremovebean = new inventoryremovebean();
  Inventoryremovebean=it_inventoryremovelist.next();
%>

				<tbody>
					<tr>
						<td><%=Inventoryremovebean.getItemid() %></td>
                    	<td><%=Inventoryremovebean.getItemname() %></td>
                    	<td><%=Inventoryremovebean.getItemamount() %></td>
                    	<td><%=Inventoryremovebean.getItemremovedamount() %></td>
                    	<td><%=Inventoryremovebean.getItemremovedate() %></td>
