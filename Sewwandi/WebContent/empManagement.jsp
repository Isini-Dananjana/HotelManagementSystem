...
body{
background-image: url('image/eBackemp2.jpg');}
...
<div class="header">
  ...
  <div class="container text-center">
   ...
   <center>  <h2>   <a href="addEmployee.jsp" style="color: #ad617b" > Add Employee</h2>  </center>    
    </div>
  </div>
        ...
        <br><br>
        <div class="container text-center"  style = "width:500px">
    <h2 style="color: black">   <a href="addAttendancePresent.jsp" style="color: #ad617b" > Employee Attendance</h2>      
        ...
        <br><br>
        <div class="container text-center"  style = "width:500px">
    <h2 style="color: black">   <a href="salManagement.jsp" style="color: #ad617b" > Employee Salary</h2>      
        ...
        <br><br>
        <div class="container text-center"  style = "width:500px">
    <h2 style="color: black">   <a href="Per_leave_applyEID.jsp" style="color: #ad617b" > Employee Leave</h2>      
