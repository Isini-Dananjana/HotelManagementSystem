...
<tr>
		 ...
		 <%
		  ...
		  <form action="editEmployee.jsp" method="post">
		    ...
		    <td><button class="btn btn-success" ><a  href="PerEmpServlet?dEmpid=<%=resultSet.getString("employeeId") %>" >Delete</a></button></td>
		   
	 <td><button style = " background-color: #f56c42" class="btn btn-success"  ><a  href="PerEmpServlet?dnewEmpid=<%=resultSet.getString("employeeId") %>" >Store</a></button></td>
