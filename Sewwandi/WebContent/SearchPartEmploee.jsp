...
<div class="wrapper">
	<div class="sidebar">
		...
		<li>
		<form method="post" action="SearchPartEmploee.jsp">
		...
		<table class="table table-condensed"  style="  background-color: #fff; padding: 30px; width: 560px;">
		 ...
		 <%
			try{
				...
				String sql ="select * from part_employee where firstname='"+fname+"' ";
		  ...
		  <form action="editPartEmployee.jsp" method="post">
		    ...
		    <td><a class="btn btn-success"  href="PartEmpServlet?dEmpid=<%=resultSet.getString("employeeId") %>" >Delete</a></td>
		   </form>
		  </tr>
		<%
