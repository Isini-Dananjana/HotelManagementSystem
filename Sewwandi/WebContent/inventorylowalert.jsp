...
<%@ page import="inventory.Inventoryalert"%>
...
.bg{background:url('img/ilw.jpg') no-repeat;
  width:100%;
  height:100%;
}
...
<body>
  ...
  <div class="header-right">
    ...
    <br>
        <div class="h1">Items Running Low</div>
...
<br>
		<header>
			...
			<butto class="btn btn-primary" style="margin-left:50px;" ><a href="inventorylowalertpdf.jsp" style="color:#fff;">Create a PDF</a></button>
...
<br>
 ...
 Inventoryalert inventoryalert= new Inventoryalert();
        ...
        List<inventorybean> inventorylist=inventoryalert.getvalues(); 
