...
<title>Check_Availability</title>
...
<form action="Available_Rooms.jsp" method="post" >
<div class="container p-3 my-3 border ">
<div id="cont" >

<div class = h4><b>Book a Room</div><br>

  <label for="Check-In"><b>Check-In:</label>
  <input type="date" id="checkIn" name="checkIn">


  <label for="Check-Out"><b>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Check-Out:</label>
  <input type="date" id="checkOut" name="checkOut" required>

  <button type="submit" href="Available_Rooms.jsp" id="clearBtn" name="checkAvailability" class="btn btn-primary btn-block" onclick="return validate();">CHECK ROOM AVAILABILITY</button>
  </div>
...
funtion valCheck(){
	   ...
	   $(".checkIn").datepicker({
	     ...
	     .on("changeDate", function(e) {
	       var checkIn = e.date, $checkOut = $(".checkOut");
	       checkIn.setDate(checkIn.getDate() + 1);
	       $checkOut.datepicker("setStartDate", checkIn);
	       $checkOut.datepicker("setDate", checkIn).focus();
	     });
