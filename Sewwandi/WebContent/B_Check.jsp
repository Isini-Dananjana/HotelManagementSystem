...
<div class="header">
  <div class="header-right">
    <a href="customerhome.jsp"><i class="fa fa-home"></i> Home</a>
    <a href="#">Register</a>
...
<div class = h4><b>Book a Room</div><br>
  ...
  <button type="submit" href="B_AvailableRooms.jsp" id="clearBtn" name="checkAvailability" class="btn btn-primary btn-block"  onclick=validate()>CHECK ROOM AVAILABILITY</button>
  </div>
