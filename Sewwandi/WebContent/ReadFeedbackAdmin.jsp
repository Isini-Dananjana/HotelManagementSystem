...
.bg{background:url('img/feed1n.jpg') no-repeat;
...
<div class="header">
  <div class="header-right">
    ...
    <a href="#">Logout</a>
		...
		<br>
        <div class="h1">Customers Feedback </div>
         ...
         <div class="col-md-12">
           <div class="scrollable">
			<span class="counter pull-right"></span>
				<table class="table table-bordered table-striped results" border="1" cellspacing="8" cellpadding="20" >
					<thead>
...
<tbody>
					<tr>
						<td><%=obj_Feedback_User_Bean.getId()%></td>
                    	<td><%=obj_Feedback_User_Bean.getFeedfirstname()%></td>
                    	<td><%=obj_Feedback_User_Bean.getFeedlastname()%></td>
                    	<td><%=obj_Feedback_User_Bean.getFeedemail()%></td>
                    	<td><%=obj_Feedback_User_Bean.getFeedbacks()%></td>
