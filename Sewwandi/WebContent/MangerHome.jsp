...
<div class="header">
  ...
  <div class="container text-center">
    <h1 style="color: black">MANAGER PANEL</h1>      
   ...
   <center>  <h2>   <a href="empManagement.jsp" style="color: #ad617b" >Employee Management</h2>  </center>    
    </div>
  </div>
        ...
        <br><br>
        <div class="container text-center"  style = "width:500px">
    <h2 style="color: black">   <a href="ManagerReports.jsp" style="color: #ad617b" > Check Reports</h2>      
