...
<%@ page import="inventory.Inventories"%>
...
.bg{background:url('img/idw.jpg') no-repeat;
  width:100%;
  height:100%;
}
...
<br>
			...
			<button class="btn btn-primary" style="margin-left:50px;" ><a href="inventorydetailspdf.jsp" style="color:#fff;">Create a PDF</a></button>
...
<br>
 ...
 Inventories inventories= new Inventories();
        ...
        List<inventorybean> inventorylist=inventories.getvalues(); 
      
        Iterator<inventorybean> it_inventorylist=inventorylist.iterator();        
%> 
			...
			<table class="table table-bordered table-striped results">
				<thead>
					<tr>
                    	...
                    	<th><b>Item Type</b></th>
                    	<th><b>Quantity</b></th>
                    	<th><b>Expected Quantity without Warning</b></th>
...
<%   
  while(it_inventorylist.hasNext()){
  
  inventorybean Inventorybean = new inventorybean();
  Inventorybean=it_inventorylist.next();
%>

				<tbody>
					<tr>
						<td><%=Inventorybean.getItemid() %></td>
                    	<td><%=Inventorybean.getItemname() %></td>
                    	<td><%=Inventorybean.getItemtype() %></td>
                    	<td><%=Inventorybean.getItemamount() %></td>
                    	<td><%=Inventorybean.getItemalertamount() %></td>
                    	<td><%=Inventorybean.getItemdate() %></td>
                    	<td><%=Inventorybean.getItemdescription() %></td>
                    	<td><a href="inventoryedit.jsp?itemid=<%=Inventorybean.getItemid()%>">Edit</a></td>
                    	<td><a href="inventorydeletecontroller.jsp?itemid=<%=Inventorybean.getItemid()%>">Delete</a></td>
					</tr>
				</tbody>
<%
}
