		...
		%>
					<div class="roomRow">
						<div class="img" >
							...
							<div class="rdetails" >									
								<form method="post" action="AddMenuOrderServlet">
									<input type="hidden" name="menuImage" value="<%=resultSet.getString("menuImage") %>">
									<h3><input name="menuId" value="<%=resultSet.getString("menuId") %>"></h3><br>
									...
									<a class="btn btn-primary"  href="menuOrderForm.jsp?menuId=<%=resultSet.getString("menuId") %>">Order</a>											 
										</form>					
							</div>
