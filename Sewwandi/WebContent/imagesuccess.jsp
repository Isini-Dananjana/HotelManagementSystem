...
<br>
  ...
  <br><br>
 <h2 style="color: #000; text-align: center;"><%=request.getAttribute("Message") %></h2>
<br>
<br>
...
<br>
<br>
<Button class="btn btn-primary btn-block"><a href="imagedetails.jsp" style="color: #fff;">Check Image List</a></Button>
<br>
