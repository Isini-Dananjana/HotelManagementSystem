...
<body>
    ...
    <ul>
      ...
      <li><a href="#">My Bookings</a>
          <ul>
                <li><a href="selectMyRBookings.jsp">Rooms</a></li>
                <li><a href="selectbooking.jsp">Events</a></li>
          </ul>
      </li>
      <li><a href="viewProfileDetails">My Profile</a>
...
<div class="header">
  ...
  <a href="Check_Availability.jsp">Rooms</a>
  <a href="checkHallAvailability.jsp">Event Halls</a>
  <a href="#">Foods</a>
  <a href="loggalleryhome.jsp">Gallery</a>
  <a href="addfeedback.jsp">Feedback</a>
  </div>
</div>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12 ">
                ...
                <br>
                <center><BUTTON class="btn btn-primary"><a href="Check_Availability.jsp" style="color: #fff;">Go to Rooms</a></BUTTON></center>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <br>
                <center><BUTTON class="btn btn-primary"><a href="checkHallAvailability.jsp" style="color: #fff;">Go to Event Halls</a></BUTTON></center>
              </div>
              <div class="col-md-6 col-sm-12">
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <br>
                <center><BUTTON class="btn btn-primary"><a href="#" style="color: #fff;">Go to Gallery</a></BUTTON></center>
              </div>
              <div class="col-md-6 col-sm-12">
                    <img src="img/media/r
                    
                    emp.jpg" style="width: 100%;height: 300px;">
              </div>
            </div>
          </div>
        </div>
