...
<div class="wrapper">
 ...
 <br>
                        ...
                        <!-- <div class="col-12 col-md-10 col-lg-8"> -->
                            <form class="card card-sm" method = "post" action="searchRmReservation.jsp">
                                <div class="card-body row no-gutters align-items-center">
                                    ...
                                    <!--end of col-->
                                   <!-- <div class="active-cyan-4 mb-4"> --><br>
                                        <input   type="date" id="checkIn" name="checkIn" required >
                                         <input  type="date" id="checkOut" name="checkOut" required>
                                 <!--    </div> -->
                                    <!--end of col-->
                                    <!-- <div class="col-auto"> -->
                                       <button class="btn btn-secondary" type="submit" href="searchRmReservation.jsp"> <i class="fas fa-search" aria-hidden="true"></i></button>
                                   <!--  </div> -->
                                    <!--end of col-->
                                </div>
                            </form>
	...
	<form method=post action= "reportTable.jsp">
	  &nbsp &nbsp &nbsp &nbsp  &nbsp<button type="submit" class="btn btn-success"><i class="fa fa-file-pdf-o" ></i> &nbsp  GET REPORT </button>
...
<br></form><hr>
 <!---------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  --------------------------------------------------------------------------------------------------------------------------------------------------------------------->      
<div class="card">
  <h4 class="card-header text-center font-weight-bold text-uppercase py-4"><i class='fas fa-book'></i>&nbsp Room bookings</h4>
  <div class="card-body">
