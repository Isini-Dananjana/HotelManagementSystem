...
<div class="header">
  <div class="header-right">
    ...
    <a href="#">Log out</a>
        ...
        <div class="h1">Add New Permanent Employee</div>
...
<div style="backdround: #ad617b" >
 ...
 <form method="POST" action="PerEmpServlet" onsubmit="return validate()"style="  background-color: #fff; padding: 30px; width: 600px;" > <!---form begins--->
		              ...
		              <center><h3 id="title">ENTER NEW EMPLOYEE DETAILS HERE</h3></center>
		                ...
		                <table id="addEmpTable"  > <!--table begins -->
			               ...
			               <tr>
			                    ...
			                    <tr>
			                       <td > <input class="logText"  type="text" name="fname" id="fname" onchange="return validate()" placeholder="Enter First Name"><br> </td>
			                    </tr>
			                    ...
			                    <tr>
		                        	<td><input class="logText" type="text" name="pNo" id="pNo" max="10" onchange="validateNewEmp()" placeholder="Enter Phone Number " pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" required> </td>
		                    	</tr>
		                 ...
		                 <div id="right-div">  
		                    ...
		                    <tr>
		                        <td><input class="logText" type="email" name="email" id="email" onchange="validateNewEmp()" placeholder="Enter Email Address" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-zA-Z]{2,4}" required> </td>
		                    </tr>
		                    ...
		                    <tr>
		                        <td><input class="logText" type="text" name="bSal" id="bSal" onchange="validateNewEmp()" placeholder="Enter Basic Salary"> </td>
		                    </tr>
