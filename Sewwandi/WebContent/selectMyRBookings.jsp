...
<form  action="My_bookings.jsp" method="post"  name="validateBooking"  action="<%= request.getContextPath() %>/#"> 
...
<br><br>
    ...
    &nbsp &nbsp &nbsp &nbsp <input type="text"  name="cName" id="cName" class="form-control"  required   value="<%=session.getAttribute("fname")%> <%=session.getAttribute("lname")%>">
    </div>
    
 	
    <br>

  <button type="submit" href="My_bookings.jsp" id="clearBtn" class="btn btn-info btn-lg btn-block" onclick="return validate();">Check My Bookings</button>
<br>  </div>
</div>
</form>
