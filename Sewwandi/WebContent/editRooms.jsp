	...
	<%
		...
		<div id = "addRoomBody" >
		 ...
		 <form   method="post" action="AddRoomServlet" onsubmit="return validateEventForm()"> 
			 ...
			 <div id="l">
			 	<input type="hidden" name="id" value="<% out.println(roomId);%>">
			 	<img id="img" src="img/media/home/room/<% out.println(imgName);%>">
			 	<input type="file" class="custom-file-input" onchange="loadFile(event); getName()"  id="imgfile">
			 	<input id="Hname" name="image" type="hidden"  value="<% out.println(imgName);%>">
			 </div>
			 <div id="r">
			 
					<input type="text" class="form-control" id="roomId"  name="roomId" value="<% out.print(roomId); %>" hidden>
			 	<br>
			 	<label for="roomType">Room type : </label>
			 	<%-- <input type="text" class="form-control" id="roomType"  name="roomType"   value="<%out.print(roomType);%>"  required >  --%> 
			 	 <!-- <!-- <label for="roomType">Room type : </label> -->
			 	  <select size = "0" class="form-control" id="roomType" name="roomType"  value="<%out.print(roomType);%>"  required>
        ...
        <option value="Non-AC Single Room">Non-AC Single Room</option>
		  		 ...
		  		 <label>Room No : </label> 
		         <input type="text" class="form-control" id="roomNo"  name="RoomNo"   value="<%out.print(roomNo);%>" required >  
		         
		         <label>Room Description  : </label> 
		         <input type="text" class="form-control" id="roomDescription"  name="roomDesc"  value="<%out.print(roomDescription);%>" required >  
		               
		         <label>Room Price (LKR) : </label> 
		         <input type="text" class="form-control" id="roomPrice"  name="roomPrice"  value="<%out.print(roomPrice);%>" required >           
			 
				 <button type="submit" id="addbtn" name="updateRoom" class="btn btn-success" ><span class="glyphicon glyphicon-plus"></span><i class='far fa-edit'></i>&nbsp Update Room</button> 
		 	</div>
