...
.bg{background:url('img/iruw.jpg') no-repeat;
  width:100%;
  height:100%;
}
...
<body>
  ...
  <div class="header-right">
    ...
    <br>
        <div class="h1">Update Or Remove Items</div>
...
%>
				...
				<tbody>
					<tr>
                    	...
                    	<td><a href="inventoryupdate.jsp?itemid=<%=Inventorybean.getItemid()%>">Update</a></td>
                    	<td><a href="inventoryremove.jsp?itemid=<%=Inventorybean.getItemid()%>">Remove</a></td>
					</tr>
				</tbody>
<%
}
