...
<div class="header">
  <div class="header-right">
    ...
    <a href="#">Logout</a>
		...
		<br>
        <div class="h1">Make an Order</div>
	...
	Supplier_User_Bean obj_Supplier_User_Bean=placeorder.getsupplier(supplierid);
...
<div class="container-fluid bg">
 ...
 <form onsubmit="return validate()" action="<%= request.getContextPath() %>/Order" method="post" class="add" >
   		<img src="img/i12.jpg" style="width: 100%; height:150px;">
...
<input type="hidden" name="supplierid" value="<%=supplierid%>"/>
    ...
    <div class="form-group">
     	...
     	<input type="text" class="form-control" id="supplierfirstname" name="supplierfirstname"  value="<%=obj_Supplier_User_Bean.getSupplierfirstname()%>"/>
    </div>


	   <div class="form-group">
  		<label for="supplierlastname">Supplier Last Name</label>
     	<input type="text" class="form-control" id="supplierlastname" name="supplierlastname" value="<%=obj_Supplier_User_Bean.getSupplierlastname()%>" />
    </div>
	
	 <div class="form-group">
    	<label for="supplieremail">E-Mail Address</label>
    <input type="text" class="form-control" id="supplieremail" name="supplieremail" value="<%=obj_Supplier_User_Bean.getSupplieremail()%>" />
    </div>
  ...
  <div class="form-group">
    	...
    	<input type="number" class="form-control" id="itemamount" name="itemamount" min="1" pattern="numbers" placeholder="Enter the item amount..." />
    </div> 
    
    
     <div class="form-group">
    	<label for="orderdate">Order Date</label>
    	<input type="date" class="form-control" id="orderdate"  name="orderdate" placeholder="Select the Date ordered..." />
    </div> 
<br>
<input type="submit" class="btn btn-primary" value="Place Order" style="width: 30%; text-align: center; position: relative;" />
  <br>  
