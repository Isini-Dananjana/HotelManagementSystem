...
<div class="wrapper">
    ...
    <br>
		<ul>
			<li><a href="Menuadd.jsp"><i class="material-icons" style= "font-size:27px">&#xe148;</i>&nbsp &nbsp Add New Menu</a></li>
			<li><a href="allmenu.jsp"><i class="material-icons" style= "font-size:27px">&#xe8ef;</i>&nbsp &nbsp Menu details</a></li>
...
<div id="cont" >
		...
		<%
			try{
				...
				String data;
				if(query != null ){ 
					data = "select * from menu where menuId like '%"+query+"%'  ";
					}
				else{
		...
		%>
					<div class="roomRow">
						<div class="img" >
							<img src="img/media/home/menu/<%=resultSet.getString("menuImage") %>" width="350px" class="img-responsive">
							
						</div>
							<div class="rdetails" >									
								<form method="post" action="AddMenuServlet">
									<input type="hidden" name="menuImage" value="<%=resultSet.getString("menuImage") %>"><br>
									<input type="text" name="menuId" value="<%=resultSet.getString("menuId") %>"><br>
									<span><%=resultSet.getString("menuDescription") %></span> &nbsp 		<input type="hidden" name="menuDescription" value="<%=resultSet.getString("menuDescription") %>">
									<p class = "price"><br>&nbsp LKR <%=resultSet.getString("menuPrice") %> </p>		<input type="hidden" name="menuPrice" value="<%=resultSet.getString("menuPrice") %>" >
									<a class="btn btn-primary" name="updateMenu" href="editMenu.jsp?menuId=<%=resultSet.getString("menuId") %>" ><i class='fas fa-user-edit'></i>   Edit</a>											 
									<a class="btn btn-primary"  name ="DeleteMenu" href="DeleteMenu.jsp?menuId=<%=resultSet.getString("menuId") %>" ><i class="fa fa-remove"></i>  Delete</a>
								</form>					
							</div>
