...
<div class="wrapper">
	<div class="sidebar">
		...
		<form method="get" action="">
			...
			<li><a href="PerEmpDetailsHistory.jsp"><i class="fa fa-download"></i>Employee History</a></li>
...
<tr>
		 ...
		 <%
			try{
				...
				String data;
				if(query != null ){ 
					data = "select * from delte_per_employee where firstname like '%"+query+"%'   or address like '%"+query+"%' or section like '%"+query+"%' or  designation like '%"+query+"%' ";
					}
				else{
					data = "select * from delte_per_employee order by employeeId desc  ";
				}
