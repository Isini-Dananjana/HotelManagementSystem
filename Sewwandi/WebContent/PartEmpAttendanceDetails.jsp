...
<div class="wrapper">
	<div class="sidebar">
		...
		<form method="get" action="">
    		<input id="fname" name="fname" type="text" class="form-control" placeholder="Enter Employee first name"><br>
  ...
  position: relative;
  transition: 0.5s;
}"><img src="img/eReport.jpg" width="28px" height="20px">  Attendance Report </button></tr>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="PartEmpAttendanceReport.jsp" method="post">
        ...
        modal.style.display = "none";
		 ...
		 <%
			try{
				...
				String data;
				if(query != null ){ 
					data = "select * from part_empattendance where firstName like '%"+query+"%' ";
					}
				else{
					data = "select * from part_empattendance order by date desc  ";
				}
			...
			%>
		  <tr>
		  <form action="editPartEmpattendance.jsp" method="post">
		  
		 <td> <%=resultSet.getString("attendanceId") %><input name="aid" type="hidden" value="<%=resultSet.getString("attendanceId") %>"></input> </td>
		  ...
		  <td><%=resultSet.getString("date") %><input  name="date" type="hidden" value="<%=resultSet.getString("date") %>"  ></input></td>
		   <td><%=resultSet.getString("employeeId") %> <input name="eid" type="hidden" value="<%=resultSet.getString("employeeId") %>"> </td>
		    ...
		    <td><%=resultSet.getString("lastName") %> <input style="border:none;width :130px" name="lname" type="hidden" value="<%=resultSet.getString("lastName") %>"></td>
		       
		    <td><%=resultSet.getString("Designation") %> <input style="border:none;width :130px " name="designation" type="hidden" value="<%=resultSet.getString("Designation") %>"></td>
		    <td><%=resultSet.getString("section") %> <input style="border:none;width :130px "name="section" type="hidden" value="<%=resultSet.getString("section") %>"></td>
