...
function validate()
{
  ...
  var itemaddedamount = document.getElementById("itemaddedamount");
  var itemupdatedate = document.getElementById("itemupdatedate");
  var itemdescription = document.getElementById("itemdescription");
    ...
    else if(itemaddedamount.value.trim() == "" ) {

        alert("Please enter the amount you want to add");
        itemaddedamount.style.border="solid 3px red";
        return false;
      }
    else if(itemupdatedate.value.trim() == ""  ) {

        alert("Please select the date!");
        itemupdatedate.style.border="solid 3px red";
        return false;
      }
...
<div class="wrapper">
 ...
 <form onsubmit="return validate()" action="<%= request.getContextPath() %>/inventoryupdatecontroller.jsp" method="post" class="update" >
 
  <img src="img/i7.jpg" style="width: 100%; height:150px;">
...
<%
  		...
  		inventorybean Inventorybean=updateinventory.getinventoryvalues(itemid);
...
<input type="hidden" name="itemid" value="<%=itemid%>"/>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      <label for="itemaddedamount">Update amount</label>
      <input type="number" class="form-control" pattern="numbers" id="itemaddedamount" name="itemaddedamount" min="1" placeholder="Enter the amount want to add" />
    </div>

    <div class="form-group">
      <label for="itemupdatedate">Date updated</label>
      <input type="date" class="form-control" id="itemupdatedate" name="itemupdatedate"  />
    </div>  


<input type="submit" class="btn btn-primary" value="Update Quantity" style="width: 30%; text-align: center; position: absolute;" />

<br>
 <p style="text-align: right;"><a href="<%=request.getContextPath()%>/inventoryadd.jsp" style="color: black;" >Item not on the list?</a></p>  
