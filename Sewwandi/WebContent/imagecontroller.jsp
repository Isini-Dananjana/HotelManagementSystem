...
<form action="./imagecontroller" method="post" class="details">

<header>	
<div class="form-group pull-left">
    <select size = "0" class="form-control" id="imagetype" name="imagetype">
...
<input type="submit" class="btn btn-primary" value="Search by type">
</div>
</header>
