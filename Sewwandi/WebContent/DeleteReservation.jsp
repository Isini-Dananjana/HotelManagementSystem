...
<%
			try{
				...
				String sql ="select * from room_reservation where roomReservationId ='"+roomReservationId+"'  ";    
...
<script type="text/javascript">
   ...
   function valDel()
  {
          ...
          alert("Your booking will be canceled!");
...
<div class="header">
  <div class="header-right">
    ...
    <a href="login.jsp">Login</a>
		...
		<br>
        <div class="h1">Delete reservation</div>
...
<input type="text" class="form-control" id="roomReservationId"  name="roomReservationId" value="<% out.print(roomReservationId); %>" hidden>
   ...
   <input type="date" class="form-control"  id="checkIn" name="checkIn" placeholder="Enter checkIn date" value="<%=resultSet.getString("checkIn") %>"required>
    ...
    <hr>
    <button type="submit"  name = "DeleteBook" class="btn btn-danger" id="submit" onclick="return valDel() ;">Cancel</button>
  </div>
