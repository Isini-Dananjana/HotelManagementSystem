...
<div class="wrapper">
 ...
 <div class="panel-body">
  <div id="bRight">
	 	<div id="availability" >
	 	  <form action="AvailableHalls.jsp" method="post" >
	 	
	 		<div id="check">
		 		<b >Enter Event Date</b><br>
		 		<input type="date" name="eventdate" class="form-control" id="eventdate"  onsubmit="return validate()">
	 			<br>
	 ...
	 <div class="row">
  <div class="column">
    <img src="img/hall1.jpg" alt="Snow" style="width:200px; height:200px">
    <figcaption>Hall No 1<br>
    			Maximum guests 100<br> price LKR 10,000</figcaption>
  </div>
  <div class="column">
    <img src="img/hall2.jpg" alt="Forest" style="width:200px; height:200px">
     <figcaption>Hall No 2<br>
    			Maximum guests 200<br> price LKR 25,000</figcaption>
  </div>
  <div class="column">
    <img src="img/hall3.jpg" alt="Mountains" style="width:200px; height:200px">
