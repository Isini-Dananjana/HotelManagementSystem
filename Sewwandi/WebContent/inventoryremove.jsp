...
<title>Remove Item details</title>
...
<script type="text/javascript">
  ...
  function validate()
  {
    ...
    var itemremovedamount = document.getElementById("itemremovedamount");
    var itemremovedate = document.getElementById("itemremovedate");
      ...
      else if(itemremovedamount.value.trim() == "" ) {

          alert("Please enter the amount you want to remove!");
          itemremovedamount.style.border="solid 3px red";
          return false;
        }
      else if(itemremovedate.value.trim() == ""  ) {

          alert("Please select the date!");
          itemremovedate.style.border="solid 3px red";
          return false;
        }
...
.bg{background:url('img/irw.jpg') no-repeat;
  width:100%;
  height:100%;
}
...
<div class="wrapper">
 ...
 <form onsubmit="return validate()" action="<%= request.getContextPath() %>/inventoryremovecontroller.jsp" method="post" class="remove" >
 
  <img src="img/i6.jpg" style="width: 100%; height:150px;">
...
<%
  		...
  		inventorybean Inventorybean=removeinventory.getinventoryvalues(itemid);
...
<input type="hidden" name="itemid" value="<%=itemid%>"/>
    ...
    <div class="form-group">
      <label for="itemamount">Current Quantity</label>
     ...
     <div class="form-group">
      <label for="itemremovedamount">Removed amount</label>
      <input type="number" class="form-control" pattern="numbers" id="itemremovedamount" name="itemremovedamount" min="1" placeholder="Enter the amount want to remove" />
    </div>

    <div class="form-group">
      <label for="itemremovedate">Date removed</label>
      <input type="date" class="form-control" id="itemremovedate" name="itemremovedate"  />
    </div>  


<input type="submit" class="btn btn-primary" value="Remove Quantity" style="width: 30%; text-align: center; position: absolute;" />
