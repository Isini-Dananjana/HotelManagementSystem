...
<title>Delete Booking Details</title>
...
<form action = "delete" method="post">
 ...
 <div class="form-group">
    	...
    	<input type="text" class="form-control"  id="eventId" name="eventId" value="<%=eventId%>" readonly >
    </div>
 ...
 <div class="form-group">
    	...
    	<input type="number" class="form-control" pattern="numbers" id="hallno" name="hallno" min="1" value="<%=hallno%>" readonly/>
   		 </div>
    
    
    <div class="form-group">
    	<label for="eventdate">Event Date</label>
    	<input type="date" class="form-control"  id="eventdate" name="eventdate" value="<%=eventdate%>" readonly/>
    </div>
    
     <div class="form-group">
    	<label for="eventtime">Event Time</label>
    	<input type="time" class="form-control"  id="eventtime" name="eventtime" value="<%=eventtime%>" readonly/>
    </div>
    
    <div class="form-group">
      <br>
    <label for="eventtype">Event type</label>
    <select size = "0" class="form-control" id="eventtype" name="eventtype" value="<%=eventtype%>" readonly>
    ...
    <div class="form-group">
    	...
    	<textarea class="form-control" style="width:100%; height:100px;" id="eventdescription" name="eventdescription" value="<%=eventdes%>" readonly><%=eventdes%></textarea>
    </div>

    <div class="form-group">
    	<label for="numberofguests">Number of guests</label>
    	<input type="number" class="form-control" pattern="numbers" id="numberofguests" name="numberofguests" min="1" value="<%=noguests%>" readonly/>
    </div>
    ...
    <option value="<%=photo%>"><%=photo%></option>
      	...
      	<option value="Thiloka lakshan">Thiloka lakshan(0772904562) LKR 20,000</option>
      	<option value="Lakindu Sandeep">Lakindu Sandeep(0771809234) LKR 35,000</option>
        <option value="Madusanka Herath">Madusanka Herath(0713343342)LKR 30,000</option>
    </select>
    </div>
...
<button class="button button3" name="cancel">Cancel</button>
