...
<script>
function myFunction() {
  alert("Successfully inserted clockout status!");
}
</script>
<style>
a.next {
		...
		<table class="table table-condensed"  style="  background-color: #fff; padding: 30px; width: 560px;">
		 ...
		 <%
			try{
				...
				String sql ="SELECT * FROM sewwandi.per_empattendanpresent where DATE(date)=CURDATE()";
		  ...
		  <td><input class="logText"   type = "hidden" name="date" id="date" value="<fmt:formatDate value="${date}" type="date" pattern="YYYY-MM-dd"/> " > </input></td>
		    ...
		    <td><input class="noOutLine" name = "section" style="border:none;width :100px"value="<%=resultSet.getString("section") %>"></td>
		      
		      <td><input class="noOutLine" name = "status" style="border:none;width :100px"value="<%=resultSet.getString("status") %>"></td>
		   
		      <td> <input name="clockin" type="" id="time" value="<%=resultSet.getString("clockin")%>" style = "width :110px ;  background-color: #cff8ff" ></td>
		    <td><input name="clockout" type="time" id="time" value= "00:00" style = "width :110px"> </td>
