...
<div class="container-fluid bg">
  <div class="row">
	...
	<div class="panel-body">
 	...
 	<form onsubmit="return validate()" action="<%= request.getContextPath() %>/valid" method="post" class="add" >
 
  		<img src="img/i3.jpg" style="width: 100%; height:150px;">

    	<div class="form-group"><br>
    	
    <label for="itemtype">Item Type</label>
    <select size = "0" class="form-control" id="itemtype" name="itemtype" placeholder="Select an Item type">
    ...
    <div class="form-group">
    	<label for="itemamount">Enter the initial amount</label>
    	<input type="number" class="form-control" pattern="numbers" id="itemamount" name="itemamount" min="1" placeholder="Enter the initial amount you want to add"/>
    </div>
    
    <div class="form-group">
    	<label for="itemalertamount">Set the Item limit to get the Running low alert</label>
    	<input type="number" class="form-control" pattern="numbers" id="itemalertamount" name="itemalertamount" min="1" placeholder="Enter the Item limit to get the Running low alert! "/>
    </div>

    <div class="form-group">
    	<label for="itemdate">Date added</label>
    	<input type="date" class="form-control" id="itemdate" name="itemdate" placeholder="Select the date" />
    </div>  

  	<div class="form-group">
    	<label for="itemdescription">Description</label>
    	<input typr="textarea" class="form-control" style="width:100%; height:100px;" id="itemdescription" name="itemdescription" placeholder="Enter a small description"/>
    </div>

<br>

<input type="submit" class="btn btn-primary" value="Add Item" style="width: 30%; text-align: center; position: absolute;" />

<br>
<br>

     <p style="text-align: right;"><a href="<%=request.getContextPath()%>/inventoryupdateandremove.jsp" style="color: black;" >Item already on the list?</a></p>
