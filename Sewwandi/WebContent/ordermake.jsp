...
<div class="container-fluid bg">
  ...
  <br>
      ...
      <input type="text" class="search form-control" placeholder="Search supplier or item"/>
      </div>
...
<tbody>
					<tr>
                    	...
                    	<td><a href="order.jsp?supplierid=<%=obj_Supplier_User_Bean.getSupplierid()%>">Order</a></td>
