...
.bg{background:url('img/omw.jpg') no-repeat;
 width:100%;
  height:100%;
}
...
<div class="form-group pull-left">
			...
			<button class="btn btn-primary" style="margin-left:50px;" ><a href="orderdetailspdf.jsp" style="color:#fff;">Create a PDF</a></button>
			
			</div>
      <div class="form-group pull-right">
      <input type="text" class="search form-control" placeholder="Search Order"/>
      </div>
...
List<orderbean> list=orders.getvalues();


Iterator<orderbean> it_list=list.iterator();
...
<tbody>
					<tr>
                    	...
                    	<td><%=Orderbean.getSupplierid()%></td>
                    	<td><%=Orderbean.getSupplierfirstname()%></td>
                    	<td><%=Orderbean.getSupplierlastname()%></td>
                    	<td><%=Orderbean.getSupplieremail()%></td>
                    	<td><%=Orderbean.getItemname()%></td>
                    	<td><%=Orderbean.getItemamount()%></td>
                    	<td><%=Orderbean.getOrderdate()%></td>
                    	
                    	
                    	<td><a href="orderedit.jsp?orderid=<%=Orderbean.getOrderid()%>">Edit</a></td>
                    	<td><a href="orderdeletecontroller.jsp?orderid=<%=Orderbean.getOrderid()%>">Delete</a></td>
